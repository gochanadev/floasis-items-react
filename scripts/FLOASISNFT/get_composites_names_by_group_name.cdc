...
pub fun main(address: Address, compositeGroupName: String, nftID: UInt64): [String] {
    ...
    return nftRef.getCompositesNamesByGroupName(compositeGroupName: compositeGroupName)
}
