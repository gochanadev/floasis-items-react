    ...
    return (
        <div>
            ...
            <div className="container">
                ...
                <p>
                    This is a <a href="https://docs.onflow.org/fcl">FCL-powered</a> app built on{" "}
                    <a href="http://onflow.org">Flow</a>.
                </p>
                ...
                <p>
                    ...
                    multi-role architecture, and designed to scale without sharding, allowing for massive improvements
                    in speed and throughput while preserving a developer-friendly, ACID-compliant environment.
                </p>
            </div>
        </div>
    );
